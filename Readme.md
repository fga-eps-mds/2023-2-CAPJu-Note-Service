...
```bash
docker exec -it note npm run migration

OU

docker exec -it note npx sequelize-cli db:migrate
...
```bash
docker exec -it note npm run shred 

OU

docker exec -it note npx sequelize-cli db:migrate:undo
